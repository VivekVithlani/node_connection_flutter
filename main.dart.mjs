...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1627: (x0,x1) => x0.querySelector(x1),
      ...
      _1880: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1881: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1906: (s, m) => {
        try {
      ...
      _1941: o => o.length,
      _1944: (o, i) => o[i],
      _1945: f => f.dartFunction,
      _1946: l => arrayFromDartList(Int8Array, l),
      _1947: l => arrayFromDartList(Uint8Array, l),
      _1948: l => arrayFromDartList(Uint8ClampedArray, l),
      _1949: l => arrayFromDartList(Int16Array, l),
      _1950: l => arrayFromDartList(Uint16Array, l),
      _1951: l => arrayFromDartList(Int32Array, l),
      _1952: l => arrayFromDartList(Uint32Array, l),
      _1953: l => arrayFromDartList(Float32Array, l),
      _1954: l => arrayFromDartList(Float64Array, l),
      ...
      _1957: l => arrayFromDartList(Array, l),
      _1958: () => ({}),
      _1959: () => [],
      _1960: l => new Array(l),
      _1961: () => globalThis,
      _1962: (constructor, args) => {
      ...
      _1964: (o, p) => o[p],
      _1965: (o, p, v) => o[p] = v,
      _1966: (o, m, a) => o[m].apply(o, a),
      _1968: o => String(o),
      _1969: (p, s, f) => p.then(s, f),
      _1970: o => {
      ...
      _2007: (d, digits) => d.toFixed(digits),
      _2189: (x0,x1) => x0.draggable = x1,
      _2205: x0 => x0.style,
      _2564: (x0,x1) => x0.download = x1,
      _2589: (x0,x1) => x0.href = x1,
      _3137: (x0,x1) => x0.accept = x1,
      _3151: x0 => x0.files,
      _3177: (x0,x1) => x0.multiple = x1,
      _3195: (x0,x1) => x0.type = x1,
      _3937: () => globalThis.window,
      _3980: x0 => x0.document,
      _3983: x0 => x0.location,
      _4274: x0 => x0.href,
      _6640: x0 => x0.signal,
      _6702: x0 => x0.baseURI,
